...
#Depois de criado, retirar da pasta dist e jogar para a pasta do projeto > ctrl+c, ctrl+v para onde você quiser.
#OBS.3: Necessário ter a versão do webbrowser do navegador(baixar a partir do google), vide sua versão em 'ajuda' > 'sobre o google chrome' - ps: não é preciso estar na mesma pasta.
