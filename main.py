...
#OBS.3: Necessário ter a versão do webbrowser do navegador(baixar a partir do google), vide versão em 'ajuda' > 'sobre o google chrome' - ps: não é preciso estar na mesma pasta.
